					...
					<div className="grid md:grid-cols-2 xl:grid-cols-3 col-span-3 gap-5">
						{fetchedProduct.map((productFetched, index) => (
							<div className="flex flex-col" key={index}>
								<Card className="col-span-12 sm:col-span-4 h-60 lg:h-[350px] relative shadow shadow-green-500">
									<Image
										as={NextImage}
										removeWrapper
									...
									/>
									<CardFooter className="absolute bottom-0 xl:right-0 z-10 justify-center flex flex-col xl:flex-row xl:justify-between p-4 bg-slate-950">
